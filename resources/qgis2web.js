...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:31984',
            //extent: [293892.340000, 8580376.250000, 308002.473895, 8596075.554516],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([292099.906681, 8584398.450658, 313849.893273, 8592594.241060], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_v2_Vertices_Extraidos_ODS_Perimetrovertices_extraidos_7,
    colName: 'Vertice',
    zoom: 10,
    collapsed: true,
    map: map,
