...
var style_v2_Vertices_Extraidos_ODS_Perimetrovertices_extraidos_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("Vertice") !== null && resolution > 0 && resolution < 7) {
        labelText = String(feature.get("Vertice"));
    }
